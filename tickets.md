...
- Final owned diff SHA-256 from coder commit `5a0de3aa8d80b7a002be5172eb7c1f0455d50755` through debugger commit `9436d2d746c54f27ce89b23c11a73850a6a7a5a7`: `a7278bd3226fc293932932bb10dd3d3150bf78d4ddbdfd43a846c48b89f157b8`. Changed paths are `extensions/workflow/index.ts`, `extensions/workflow/repo-registry.test.ts`, and `extensions/workflow/issue-list.test.ts`; no policy, shared snapshot, subagents, or UI-customization path changed. Fetched `origin/main` and `git ls-remote --heads origin main` both read commit `9436d2d746c54f27ce89b23c11a73850a6a7a5a7`.
