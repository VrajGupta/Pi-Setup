...
- Final owned diff SHA-256 before tracker/handoff update: `0fdfaf48e5e46d3365ade48dde1a645fead264f94b07fc23c6e83f14e1a28cc2`. Changed paths are `extensions/workflow/index.ts`, `extensions/workflow/repo-registry.test.ts`, and `extensions/workflow/issue-list.test.ts`; no policy, shared snapshot, subagents, or UI-customization path changed.
